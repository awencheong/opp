...
<?php if ($_valid && !is_callable('content_54c09064030f12_75461265')) {function content_54c09064030f12_75461265($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/home/awen/product/opp/smarty/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/awen/product/opp/smarty/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include '/home/awen/product/opp/smarty/libs/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include '/home/awen/product/opp/smarty/libs/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include '/home/awen/product/opp/smarty/libs/plugins/function.html_options.php';
