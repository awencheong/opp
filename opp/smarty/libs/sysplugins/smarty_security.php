...
class Smarty_Security
{
    ...
    public function isTrustedPhpFunction($function_name, $compiler)
    {
        ...
        return false; // should not, but who knows what hoppens to the compiler in the future?
    }
     ...
     * is reduced to "http://hello.world.example.org" prior to opplying the patters from {@link $trusted_uri}.
     *
     * @param  string $uri
     *
