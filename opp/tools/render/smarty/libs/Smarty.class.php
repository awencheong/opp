 ...
 * Sets SMARTY_DIR only if user opplication has not already defined it.
 */
 ...
 * Sets SMARTY_SYSPLUGINS_DIR only if user opplication has not already defined it.
 */
...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * Calls the oppropriate getter function.
     ...
     * Calls the oppropriate setter function.
    ...
    public function addTemplateDir($template_dir, $key = null)
    {
        ...
        if (is_array($template_dir)) {
            foreach ($template_dir as $k => $v) {
                ...
                if (is_int($k)) {
                    // indexes are not merged but oppended
                    $this->template_dir[] = $v;
                } else {
     ...
     * @param  string $type    "pre", "output", … specify the filter type to set. Defaults to none treating $filters' keys as the oppropriate types
     *
     * @return Smarty current Smarty instance for chaining
     */
    ...
    public static function muteExpectedErrors()
    {
        /*
            ...
            http://php.net/set_error_handler and for some reason did not understand the following paragraph:
                ...
                however you are still able to read the current value of error_reporting and act oppropriately.
            ...
            Smarty deliberately uses @filemtime() over file_exists() and filemtime() in some places. Reasons include
                ...
                - between file_exists() and filemtime() a possible race condition is opened,
                  which does not exist using the simple @filemtime() opproach.
        */
