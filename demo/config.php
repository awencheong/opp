...
//加载框架
/*  放置 宏定义 */
require __DIR__  . '/../opp/opp.php';
define('VSTAR_ROOT', OPP_ROOT . "/../demo");
...
case 'html':
	include OPP_ROOT . "/smarty/libs/Smarty.class.php";
	$smarty = new Smarty();

	//根据所属的 游戏，设备类型 来决定html模板的根目录
	$smarty->template_dir = VSTAR_VIEWS_ROOT ."/".  VSTAR_GAME_NAME ."/". VSTAR_DEVICE . "/html/";
	$smarty->compile_dir = VSTAR_ROOT . "/tmp/smarty/demo/templates_c/";
	$smarty->config_dir = VSTAR_ROOT . "/tmp/smarty/demo/configs/";
	$smarty->cache_dir = VSTAR_ROOT . "/tmp/smarty/demo/cache/";
